...
time_between_samples = nanmean(time_between_samples);
%
% Plot
% X
figure
...
%
p2p_temp = locs*time_between_samples;
...
L = length(time_matrix); % length of signal
...
grid on
%
% Construct lowpass filter cut-frequency 11Hz
% where a = T/tau, T = the time between samples, and tau is the filter
% time constant
%
a = time_between_samples/(1/5);
